...
class UploadHandler {
	...
	protected $error_messages = array(1 => 'The uploaded file exceeds the upload_max_filesize directive in php.ini',
	 2 => 'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form',
	  ...
	  'max_file_size' => 'File is too big', 'min_file_size' => 'File is too small', 
	...
	function __construct($options = null, $initialize = true, $error_messages = null) {
		$this -> options = array('script_url' => $this -> get_full_url() . '/', 
		...
		if ($this -> validate($uploaded_file, $file, $error, $index)) {
			...
			if ($uploaded_file && is_uploaded_file($uploaded_file)) {
				...
				if ($append_file) {
					...
					//echo "trimed name = ".str_replace(' ', '',$name)."<br>";
					$cmd = $python . ' upload_to_s3-2.py '.str_replace(' ', '',$name) .' '.$uploaded_file.' output/ 2>&1';
					exec($cmd,$output,$return);
					
					//move_uploaded_file($uploaded_file, $file_path);
					//echo var_dump($return);
					/*echo "<br>-----------------------------------------------------<br>";
					echo "append_file = ". var_dump($append_file). "<br>";
					echo "file_path = ". $file_path. "<br>";
					echo "file_size = ".$this -> get_file_size($file_path). "<br>";
					echo "Actual file size =  ". $file -> size ."<br>";*/
					//move_uploaded_file($uploaded_file, $file_path);
					if(!$return){
						$file -> url = $output;
