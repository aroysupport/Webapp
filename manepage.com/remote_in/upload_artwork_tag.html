		...
		<div class="wrapper">
			<div class="wrapper-container">
				<div class="main_page">
					...
					<div id="upload_artwork_tag_page">
						<h2>^ Tag Artwtork</h2>
						<ul>
							<li>
								<div class="text-value">
									<input type="text" value="^^Brand Name" /><br />
									<input type="text" value="^^#keyword1" /><br />
									<input type="text" value="^^#keyword2" />
								</div>
								<div class="thumbnail-tag"><span>Thumbnail</span></div>
								<div class="clear"></div>
							</li>
							<li>
								<div class="text-value">
