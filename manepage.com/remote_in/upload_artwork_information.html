		...
		<div class="wrapper">
			<div class="wrapper-container">
				<div class="main_page">
					...
					<div id="upload_artwork_information_page">
						<h2>^ Upload Information</h2>
						<p>Brand owners can send messages to this device to request a license to artwork you have uploaded today. Remember, all upload previews are deleted after 2 years. Artists retain all ownership rights and can keep 100% of the profits from your work. Mane Page only provides a bridge between artists and brand owners. You are free to work out your own deals with the brand owner. To help amatuer artists sell their work, Mane Page also provides a free standard license framework and suggested pricing structure for the sale of royalty-free art.</p>
						<input type="cancel" value="Close" />
