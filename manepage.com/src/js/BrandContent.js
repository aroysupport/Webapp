$(function() {
	...
	$.getJSON(domain+"/php/api_brand.php?method=Brand_page&brand=" + getURLParameter("brand"), function(resopnse) {
		//console.log(resopnse);
		$.each(resopnse, function(index, key) {
			switch(index) {
			case "Brand_name":
				$(".brand_content_page h3").html(key);
				$(".brand_content_page .brand_content li #fix-brand").html(key);
				break;
			case "Brand_id":
				break;
			case "Brand_philo":
			...
			case "CollectionName":
				...
				//$(".brand_content_page .brand_content li:eq(0)").html(key);
				break;
			case "ProductName":
